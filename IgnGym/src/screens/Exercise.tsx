...
export function Exercise() {
  ...
  async function fetchExerciseDetails() {
    try {
      ...
      const title = isAppError ? error.message : 'Nao foi possível carregar os detalhes dos exercícios.'
      toast.show({
        title,
        placement: 'top',
        bgColor: 'red.500'
  ...
  async function handleExerciseHistoryRegister() {
    try {
      ...
      const isAppError = error instanceof AppError;
      const title = isAppError ? error.message : 'Nao foi possível registrar o exercício.'
      toast.show({
        title,
        placement: 'top',
        bgColor: 'red.500'
